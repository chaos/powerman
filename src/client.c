...
void cli_init(void)
{
     ...
     */
    client_prot->scripts[PM_ERROR] = NULL;
    _mkexpect(&client_prot->scripts[PM_LOG_IN],	      "powerman");
    _mkexpect(&client_prot->scripts[PM_CHECK_LOGIN],  "check login");
    _mkexpect(&client_prot->scripts[PM_LOG_OUT],      "quit");
    _mkexpect(&client_prot->scripts[PM_UPDATE_PLUGS], "update plugs");
    _mkexpect(&client_prot->scripts[PM_UPDATE_NODES], "update nodes");
    _mkexpect(&client_prot->scripts[PM_POWER_ON],     "on ([^[:space:]]+)");
    _mkexpect(&client_prot->scripts[PM_POWER_OFF],    "off ([^[:space:]]+)");
    _mkexpect(&client_prot->scripts[PM_POWER_CYCLE],  "cycle ([^[:space:]]+)");
    _mkexpect(&client_prot->scripts[PM_RESET],	      "reset ([^[:space:]]+)");
    _mkexpect(&client_prot->scripts[PM_NAMES],	      "names ([^[:space:]]+)");
}
