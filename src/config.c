...
/* PM_LOG_IN 1 */
    ...
    script_el = make_Script_El(EXPECT, string1 =
			       make_String("powerman"), string2 =
			       make_String("\n"), NULL, tv);
...
/* PM_CHECK_LOGIN 2 */
    ...
    script_el = make_Script_El(EXPECT, string1 =
			       make_String("check login"), string2 =
			       make_String("\n"), NULL, tv);
...
/* PM_UPDATE_PLUGS 4 */
    ...
    script_el = make_Script_El(EXPECT, string1 =
			       make_String("update plugs"), string2 =
			       make_String("\n"), NULL, tv);
...
/* PM_UPDATE_NODES 5 */
    ...
    script_el = make_Script_El(EXPECT, string1 =
			       make_String("update nodes"), string2 =
			       make_String("\n"), NULL, tv);
			  ...
			  struct timeval tv)
{
	...
	Regcomp(&(script_el->s_or_e.expect.completion), get_String(s2),
		cflags);
